...
onready var background = preload("res://Art/HEY.png")
...
func _on_screen_resized():
	...
	VisualServer.black_bars_set_images(background.get_rid(), background.get_rid(), background.get_rid(), background.get_rid())
